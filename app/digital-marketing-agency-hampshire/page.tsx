    ...
    <div>
      ...
      <section className="py-24 bg-gradient-to-b from-white to-dark-50">
        <div className="container max-w-3xl">
          <h2 className="text-5xl font-bold mb-8 bg-gradient-to-r from-dark-900 to-dark-700 bg-clip-text text-transparent">Digital Marketing in Hampshire</h2>
          <div className="space-y-6">
            <p className="text-xl text-dark-600 leading-relaxed">
              FCAB Digital is a digital marketing agency for Hampshire. We help companies in the region reach their target audience, generate leads, and grow revenue through proven digital strategies.
            </p>
            ...
            <p className="text-lg text-dark-600 leading-relaxed">
              As a creative marketing agency, our campaigns and work look at the bigger picture. Our team will create digital marketing strategies aimed at providing brand awareness, engagement, and growth for your business.
            </p>
        ...
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="text-5xl font-bold text-primary-500 mb-2">120+</div>
      ...
      <section className="py-16 bg-gradient-to-b from-dark-50 to-white">
        <div className="container max-w-4xl">
          ...
          <p className="text-dark-600 text-center mb-12">Real feedback from Hampshire businesses we've helped</p>
