...
export default function LeatherheadPage() {
  const town = 'Leatherhead';
  const county = 'Surrey';
  ...
  return (
    <div>
      ...
      <section id="services" className="py-20 bg-white">
        <div className="container">
          <h2 className="text-4xl font-bold text-center mb-4">What We Do For {town} Businesses</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <div className="p-8 bg-gradient-to-br from-primary-50 to-primary-100 rounded-xl border border-primary-200 hover-lift">
              ...
              <p className="text-dark-600 mb-4">Rank higher in Google and get discovered by customers searching for your services in {town}.</p>
            ...
            <div className="p-8 bg-gradient-to-br from-primary-50 to-primary-100 rounded-xl border border-primary-200 hover-lift">
              ...
              <p className="text-dark-600 mb-4">Modern, fast, conversion-focused websites that represent your business and drive sales.</p>
              <ul className="space-y-2 text-sm">
            ...
            <div className="p-8 bg-gradient-to-br from-accent-50 to-accent-100 rounded-xl border border-accent-200 hover-lift">
              ...
              <p className="text-dark-600 mb-4">Organise customer relationships and automate your sales process to close more deals faster.</p>
              <ul className="space-y-2 text-sm">
      ...
      <section className="py-20 bg-dark-900 text-white">
        <div className="container">
          <h2 className="text-4xl font-bold text-center mb-16">Why {town} Businesses Choose FCAB</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 border-l-4 border-primary-500 hover-lift">
              <div className="text-4xl mb-4">🎯</div>
              <h3 className="text-xl font-bold mb-3">Local Expertise</h3>
              <p className="text-dark-200">We understand {town}'s market and competition. You get strategies built for your local landscape, not generic templates.</p>
            </div>
            <div className="p-8 border-l-4 border-accent-500 hover-lift">
              <div className="text-4xl mb-4">📈</div>
              <h3 className="text-xl font-bold mb-3">Proven Results</h3>
              <p className="text-dark-200">We focus on ROI first. Every campaign is measured against your business goals. You see the numbers.</p>
            </div>
            <div className="p-8 border-l-4 border-primary-500 hover-lift">
              <div className="text-4xl mb-4">🤝</div>
              <h3 className="text-xl font-bold mb-3">True Partnership</h3>
              <p className="text-dark-200">You work directly with our team. No account managers reading scripts. Honest, strategic advice from people who care about your growth.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="hidden md:flex justify-between items-start mb-12">
              {[
                ...
                { num: '2', title: 'Strategy', desc: 'Develop a custom plan for your market.' },
      ...
      <section className="py-20 bg-gradient-to-r from-primary-500 to-accent-500 text-white">
        <div className="container text-center max-w-2xl">
          <h2 className="text-4xl font-bold mb-6">Ready to Grow Your {town} Business?</h2>
