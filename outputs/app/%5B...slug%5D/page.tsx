...
export default function DynamicPage({ params }: { params: { slug: string[] } }) {
  ...
  const content = `
    <h2>Digital Marketing Agency Serving ${locationData.region}</h2>
    <p>${locationData.description} We're a full-service digital marketing agency helping local businesses grow online and compete effectively in their market.</p>
